          ...
          <div class="col-10 col-md-6 col-lg-4 p-2" data-toggle="modal" data-target="#detail<?= $card['card_id'] ?>">
            <div class="card shadow-dark radius-border-6 hyper-bg-white hyper-card h-100" style="border:3px solid #2E384D !important;">
              ...
              <div class="card-body">
                ...
                <?php elseif ($card['isactive'] == '0') : ?>
                  <h6 class="mt-0" style="color: red;">ไม่พร้อมส่ง</h6>
                <?php endif; ?>
              ...
              <div class="modal-content border-0 radius-border-2 hyper-bg-white">
                ...
                <div class="modal-body text-left">
                    ...
                    <div id="insub" class="carousel slide" data-ride="carousel" style="padding: 10px;">
                      ...
                      <div class="carousel-inner align-items-center">
                        <div class="carousel-item active" align="center">
                          <img src="https://dexystore.me/assets/img/img11.png" class="d-block w-70 carousel" alt="...">
                        </div>
                        <div class="carousel-item" align="center">
                          <img src="https://dexystore.me/assets/img/img2.png" class="d-block w-70 carousel" alt="...">
                        </div>
                        <div class="carousel-item" align="center">
                          <img src="https://dexystore.me/assets/img/img33.png" class="d-block w-70 carousel" alt="...">
                        </div>
                        <div class="carousel-item" align="center">
                          <img src="https://dexystore.me/assets/img/img4.png" class="d-block w-70 carousel" alt="...">
                        </div>
                      </div>
                  ...
                  <div class="modal-footer p-2 border-0 row">
                    ...
                    <button <?php if ($card['isactive'] == '1') : ?> onclick="BuyItem(this)" <?php elseif ($card['isactive'] == '0') : ?> onclick="notActive()" <?php endif; ?> value="<?= $card['card_id'] ?>" class="btn  hyper-btn-buy mb-2 mb-md-0 mr-0 mr-md-2 "><i class="fal fa-shopping-cart mr-1"></i>ซื้อสินค้า</button>
