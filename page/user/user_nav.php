...
<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #131315;">
	...
	<a href="home" class="navbar-brand ml-3" style="width: 10%"><img src="../../assets/img/logodexystore.png" width="100" height="50" class="d-inline-block align-top rounded-circle"></a>
	<!-- ON Mobile -->
