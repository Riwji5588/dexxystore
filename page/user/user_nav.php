...
<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #131315;">
	...
	<a href="home" class="navbar-brand ml-3" style="width: 10%"><img src="https://dexystore.me/assets/img/logodexystore1.png" width="100" height="50" class="d-inline-block align-top rounded-circle"></a>
	<!-- ON Mobile -->
	...
	<ul id="onpc" class="navbar-nav ml-auto align-items-center " style="display:inline-flex; ">
		...
		<li class="nav-item" style="margin-right:15px;">
			<button class="btn " data-toggle="modal" data-target="#notification">
				...
				<sup style="color: #13C33F;font-size:14px;"><?= mysqli_num_rows($notify) ?></sup>
			</button>
		</li>
