                      ...
                      <form method="POST" enctype="multipart/form-data">
                        ...
                        <div id="slideimg<?= $card['card_id'] ?>" class="card-img-top img-fluid carousel slide " data-ride="carousel">
                          <div class="carousel-inner">
                            ...
                            <?php $active = 0;
                            } while ($edit_card_image = mysqli_fetch_array($query_edit_card_image)); ?>
            ...
            <ul class="pagination justify-content-center mb-0 mt-3">
              ...
              <?php for ($i = 1; $i <= $total_page; $i++) { ?>
                <li class="page-item"><a class="page-link <?php if ($_GET['page'] == $i) {
                                                            echo 'active';
                                                          } ?>" href="gamecard&gameid=<?= $game['game_id']; ?>&page=<?= $i; ?>"><?= $i; ?></a></li>
              <?php } ?>
        ...
        <script>
          ...
          $("#addgamecard").submit(function(additem) {
            ...
            $.ajax({
              ...
              beforeSend: function() {
                swal("กำลังเพิ่มการ์ดแสดงสินค้า กรุณารอสักครู่...", {
                  button: false,
                ...
                .then((willDelete) => {
                  if (willDelete) {
                    ...
                    $.ajax({
                      ...
                      beforeSend: function() {
                        swal("กำลังอัพเดทการ์ดแสดงสินค้า กรุณารอสักครู่...", {
                          button: false,
                          closeOnClickOutside: false,
                          timer: 500,
                        });
