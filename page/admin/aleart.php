...
<h3 class="text-center mt-4" style="color: white;">--- การเคลม ---</h3>
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        if (data[i].claim_data_confirm != 9) {
                            ...
                            <!-- aleart Data Modal -->
                                                ...
                                                ${data[i].claim_data_confirm == 0 ? `
                                                        <div class="mr-2 mb-1">
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <button id="confirmbtnr${data.claim_data_id}" type="button" class="btn btn-danger btn-sm p-1 px-2" data-toggle="modal" data-target="#reject${data[i].id}">ปฏิเสธ</button>
                                                            </div>
                                                        </div>` : ''}
                                                    </div>
                                                </div>
                                ...
                                <!-- sub modal -->
                                <div class="modal fade" id="reject${data[i].id}" data-backdrop="static">
